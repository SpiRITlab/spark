...
object UDTRegistration extends Serializable with Logging {
  ...
  private lazy val udtMap: mutable.Map[String, String] = mutable.Map(
    ...
    ("org.apache.spark.ml_fhe.linalg.CtxtVector", "org.apache.spark.ml_fhe.linalg.CtxtVectorUDT"),
    ("org.apache.spark.ml_fhe.linalg.CtxtDenseVector", "org.apache.spark.ml_fhe.linalg.CtxtVectorUDT"))
